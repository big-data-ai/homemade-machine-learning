...
print("My Train_data.shape: ", train_data.shape)
...
print("The all_scores is: %f and mean value is: %f", (all_scores, np.mean(all_scores)))
"""
...
for i in range(k):
    ...
    history = model.fit(partial_train_data, partial_train_targets,
                        ...
                        epochs=num_epochs, batch_size=num_batchSize, verbose=0)
    
    mae_history = history.history['val_mean_absolute_error']
    all_mae_histories.append(mae_history)

test_mse_score, test_mae_score = model.evaluate(test_data, test_targets)
print("Test MSE_Score:", test_mse_score, "\n Test MAE Score:", test_mae_score)
average_mae_history = [
